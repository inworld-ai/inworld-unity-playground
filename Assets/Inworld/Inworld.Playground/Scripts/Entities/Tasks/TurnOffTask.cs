...
namespace Inworld.Map
{
    ...
    public class TurnOffTask : Task
    {
        public override IEnumerator Perform(InworldCharacter inworldCharacter, List<TriggerParameter> parameters)
        {
            ...
            {
                EntityManager.Instance.FailTask(this, inworldCharacter, $"Could not turn off: {itemID}.");
                yield break;
            }
            ...
            if(animatorBoolParamHandler.SetFalse())
                ...
                EntityManager.Instance.FailTask(this, inworldCharacter, $"{itemID} is already off.");
        }
    }
}

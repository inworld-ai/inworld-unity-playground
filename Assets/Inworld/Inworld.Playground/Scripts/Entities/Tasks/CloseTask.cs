...
namespace Inworld.Map
{
    ...
    public class CloseTask : Task
    {
        public override IEnumerator Perform(InworldCharacter inworldCharacter, List<TriggerParameter> parameters)
        {
            ...
            {
                EntityManager.Instance.FailTask(this, inworldCharacter, $"Could not close: {itemID}.");
                yield break;
            }
            ...
            if(animatorBoolParamHandler.SetFalse())
                ...
                EntityManager.Instance.FailTask(this, inworldCharacter, $"{itemID} is already closed.");
        }
    }
}

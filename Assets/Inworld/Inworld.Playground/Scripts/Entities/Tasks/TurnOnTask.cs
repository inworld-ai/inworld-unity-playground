...
namespace Inworld.Map
{
    ...
    public class TurnOnTask : Task
    {
        public override IEnumerator Perform(InworldCharacter inworldCharacter, List<TriggerParameter> parameters)
        {
            ...
            {
                EntityManager.Instance.FailTask(this, inworldCharacter, $"Could not turn on {itemID}.");
                yield break;
            }
            ...
            if(animatorBoolParamHandler.SetTrue())
                ...
                EntityManager.Instance.FailTask(this, inworldCharacter, $"{itemID} is already on.");
        }
    }
}
